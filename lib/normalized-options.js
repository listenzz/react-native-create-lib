...
module.exports = options => {
  ...
  const exampleName = options.exampleName || `${pascalCase(name)}Example`

  return Object.assign(options, { name, repoName, moduleName, className, classNameWithPrefix, exampleName })
}
